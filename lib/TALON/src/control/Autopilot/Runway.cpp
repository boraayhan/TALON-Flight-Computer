...
Runway::Runway(String name, const Vector3 &startPositionMeters, const Vector3 &endPositionMeters) {
  this->name = name;
...
Runway::Runway(String name, const Vector3 &startPositionMeters, float distanceMeters, const Vector3 &direction) {
  this->name = name;
  this->startPositionMeters = startPositionMeters;
...
String Runway::toJSON() {
  return "{\"name\": \"" + this->name + "\", \"startPosition\": {\"x\": " + String(this->startPositionMeters.x, 2) +
         ", \"y\": " + String(this->startPositionMeters.y, 2) + ", \"z\": " + String(this->startPositionMeters.z, 2) +
         "}, \"endPosition\": {\"x\": " + String(this->endPositionMeters.x, 2) +
         ", \"y\": " + String(this->endPositionMeters.y, 2) + ", \"z\": " + String(this->endPositionMeters.z, 2) + "}}";
}
