...
Runway::Runway(std::string name, const Vector3 &startPositionMeters, const Vector3 &endPositionMeters)
{
    this->name = name;
...
Runway::Runway(std::string name, const Vector3 &startPositionMeters,
...
{
    return "{\"name\": \"" + this->name + "\", \"startPosition\": {\"x\": " + std::to_string(startPositionMeters.x) + ", \"y\": " + std::to_string(startPositionMeters.y) + ", \"z\": " + std::to_string(startPositionMeters.z) + "}, \"endPosition\": {\"x\": " + std::to_string(endPositionMeters.x) + ", \"y\": " + std::to_string(endPositionMeters.y) + ", \"z\": " + std::to_string(endPositionMeters.z) + "}}";
}
