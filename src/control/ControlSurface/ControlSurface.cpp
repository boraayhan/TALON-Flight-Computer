...
ControlSurface::ControlSurface(int GPIO_PIN, String name, ControlSurfaceType type, float angleZeroDegrees,
                               float angleServoMinDegrees, float angleServoMaxDegrees, int DIRECTION_MULTIPLIER) {
